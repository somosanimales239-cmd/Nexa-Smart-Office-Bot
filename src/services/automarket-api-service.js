...
const RESOURCE_FIELD_ALLOWLISTS = Object.freeze({
  ...
  listings: ['id','listing_id','store_id','dealer_id','dealer_name','store_name','title','listing_title','slug','category','subcategory','price','condition','status','quantity','description','short_description','location','address','city','state','zip','dealer_location','store_location','image','url','main_image_url','listing_image_url','gallery_images','video_url','listing_url','financing_enabled','created_at','updated_at','year','make','model','trim','mileage','vin','stock_number','title_status','fuel_type','transmission','exterior_color','interior_color'],
  orders: ['id','order_id','lead_id','appointment_id','listing_id','store_id','store_name','dealer_id','dealer_name','listing_title','listing_url','listing_image_url','name','email','phone','location','customer_name','customer_email','customer_phone','customer_location','message','order_notes','order_type','source','source_context','source_label','created_by_platform','status','created_at','updated_at','reseller_id','reseller_name','reseller_email','appointment_date','appointment_time','appointment_label','appointment_status','appointment_result_status','sale_status','sale_price','appointment_commission_percent','appointment_commission_amount','commission_percent','commission_amount','dealer_status_note','lead_url'],
  ...
  'reseller-listings': ['id','assignment_id','listing_id','store_id','dealer_id','dealer_name','store_name','dealer_phone','store_phone','dealer_email','store_email','dealer_location','store_location','address','city','state','zip','listing_title','listing_url','listing_image_url','price','category','status','commission_percent','agreement_status','created_at'],
  ...
  stores: ['id','store_id','owner_id','dealer_id','dealer_name','store_name','slug','email','phone','location','address','city','state','zip','status','logo_url','banner_url','listings_count','orders_count','created_at','updated_at','public_store_url'],
