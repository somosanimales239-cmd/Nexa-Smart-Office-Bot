...
test('Dealer Agenda booked appointments remove an otherwise open website slot from Knowledge', function () {
  ...
  assert.match(match.response, /no verified appointment times|does not show verified open appointment times|does not show a verifiable opening|no other verified/i);
});
