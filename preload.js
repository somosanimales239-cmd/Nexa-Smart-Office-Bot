...
contextBridge.exposeInMainWorld('nexa', Object.freeze({
  ...
  messages: Object.freeze({
    ...
    aiToggle: function aiToggle(enabled) { return invoke('messages:ai-toggle', { enabled: enabled === true }); },
    autoReplyBlock: function autoReplyBlock(threadId, blocked) { return invoke('messages:auto-reply-block', { thread_id: threadId, blocked: blocked === true }); },
