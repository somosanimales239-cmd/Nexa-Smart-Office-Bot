...
contextBridge.exposeInMainWorld('nexa', Object.freeze({
  ...
  messages: Object.freeze({
    ...
    setAutoReplyBlocked: function setAutoReplyBlocked(threadId, blocked, reason) { return invoke('messages:auto-reply-block', { thread_id: threadId, blocked: blocked === true, reason: reason || '' }); },
